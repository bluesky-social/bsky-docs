...
export function convertObject(
  ...
  if ((id == "app.bsky.feed.sendInteractions" || id == "chat.bsky.actor.deleteAccount" || id == "tools.ozone.set.deleteSet" || id == "tools.ozone.setting.removeOptions" || id == "tools.ozone.verification.listVerifications" || id == "tools.ozone.moderation.getSubjects") && Object.keys(properties).length == 0) {
    properties = {
      _unknown_: {
        type: "object",
        properties: {},
