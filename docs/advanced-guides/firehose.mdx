...
to the [JetStream](https://jazco.dev/2024/09/24/jetstream/) websocket:
<Tabs>
  <TabItem value="python" label="Python">
    ...
    async def listen_to_websocket(keywords, log):
    ...
    asyncio.get_event_loop().run_until_complete(listen_to_websocket(args.keywords, args.log))
    ```
  </TabItem>
</Tabs>
