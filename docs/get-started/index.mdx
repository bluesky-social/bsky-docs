...
- Keep going with the Get Started guides, like [creating a post with rich text](/docs/get-started/creating-a-post) or [viewing feeds](/docs/get-started/viewing-feeds).
- Sync the network in realtime with [Jetstream](/docs/jetstream) or [the Relay](/docs/relay).
