...
Muting a user hides their posts from your feeds. Mutes are private — like Bookmarks, they are stored on the [Bluesky AppView](https://atproto.com/guides/overview#app-views), rather than in your PDS. Muting a user is as easy as liking a post or following a user.
