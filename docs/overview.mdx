...
The Authenticated Transfer Protocol, or atproto, is a federated protocol for large-scale distributed social applications. In the near future, social apps primarily for photos, videos, longform blogging, etc. can be built on atproto as well.

TODO: review links, add images, revise content. just standing up the page for now
...
From here, you can continue reading the docs.
