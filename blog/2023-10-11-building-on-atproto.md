...
* Feed generators
    ...
    * Get started with our [custom feed tutorial](https://atproto.com/guides/custom-feed-tutorial). 
* Bots
    ...
    * Get started with a template for a Bluesky bot [here](/docs/get-started).
* Bluesky clients
    * Because the AT Protocol is open, third-party developers can create entirely separate frontends for the network too.
    * Here's a [starter template](/docs/get-started) for building a Bluesky client.
